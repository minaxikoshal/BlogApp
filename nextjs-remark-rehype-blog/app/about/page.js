          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-2/3 flex flex-col justify-center ">
              ...
              <p className="text-gray-600 dark:text-gray-50 text-lg mb-4">
                Hello! I'm Ginni, a passionate software developer and tech
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white">
              Ginni's Journey as a Coder
            </h2>
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-50">
              From curious beginner to seasoned developer, here's how Ginni
          ...
          <div className="space-y-12">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  Ginni’s coding journey began in high school when he stumbled
                  upon his first programming language—Python. What started as a
                  simple curiosity quickly turned into a passion, as Ginni spent
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              ...
              <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  After mastering the basics, Ginni’s thirst for knowledge grew.
                  He began exploring more complex topics such as data
                  structures, algorithms, and web development. Enrolling in
                  online courses and attending coding bootcamps, Ginni quickly
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/3">
                <img
                  src="/demo.gif"
                  alt="Ginni working on a big project"
                  className="w-full rounded-lg shadow-lg"
                />
              </div>
              <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  With several years of experience under his belt, Ginni began
                  tackling more significant challenges. From contributing to
                  open-source projects to developing his own applications, Ginni
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              ...
              <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  Today, Ginni is not only a proficient coder but also a mentor
                  ...
                  development. For Ginni, coding is more than just a
